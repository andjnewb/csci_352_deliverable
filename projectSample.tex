...
\title{Final Project Documentation Starter\\ for UTM CSCI 352}
%
%

% received ..."  text while in non-compsoc journals this is reversed. Sigh.

\author{Kathleen Ericson\\ (you'll need to take me out and put your names in here)% <-this % stops a space
}

\IEEEtitleabstractindextext{%
\begin{abstract}
Abstracts are generally a very concise, short description of what you are writing about.  It's good to get into the habit of writing them.  Give a 1 paragraph explanation of your project, who the target is, and what you feel you have achieved so far in the project.
\end{abstract}
