...
\begin{abstract}
This computer application uses the OpenWeatherAPI to collect certain weather data such as temperature, humidity, etc. to predict the weather forecast throughout 
...
\item Capacity - The app will have teh same capacity as the storage on the computer i.e. The user will be able to have as many locations as their phone or computer can fit.
\end{itemize}
