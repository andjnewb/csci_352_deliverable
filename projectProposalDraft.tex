...
\begin{enumerate}
\item If the user wishes the application to find their location, they will click on the alert that the application is trying to access their location (whatever device they are on will handle this message differently).
